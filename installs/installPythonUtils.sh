...
if [[ "$(getOsVers)" == "16.04" || "$(getOsVers)" == "18.04" ]]; then
	# python2
	sudo apt-get install --yes python-pip ipython python-dateutil python-argcomplete python-colorlog
	...
	# python3
	sudo apt-get install --yes python3-pip ipython3 python3-dateutil python3-colorlog
